...
THIS IS OUR CMPE209 PROJECT AT SAN JOSE STATE UNIVERSITY.(FALL 2015) 


------------------------------- A NETWORK MONITORING TOOL IN PYTHON -----------------------------------------
...
auth_users={"root":"root","pradyumna":"pradyumna"}
...
def geoip_city(string):
	if string in black_listed_ip:	
		path='/home/pradyumna/build/geoip/GeoLiteCity.dat'
				...
				if str(sys.argv[2])==auth_users[str(sys.argv[1])]:
					...
					try:
						...
						if str(sys.argv[3])=="cli":
							f=open('/home/pradyumna/Downloads/fuzz-2006-06-26-2594.pcap')
